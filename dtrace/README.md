...
* carp_debug* - was used to troubleshoot problem with wrong TTL in CAPR packets. óonclusion - dummynet(4) is not compatible with local generated multycast (including carp traffic)
